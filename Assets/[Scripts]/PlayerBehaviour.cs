...
public class PlayerBehaviour : MonoBehaviour
{
    ...
    private void Move()
    {
        ...
        {
            Vector2 direction = new Vector2(worldTouch.x - transform.position.x, worldTouch.y - transform.position.y);
            ...
            if (isGrounded)
            {
                ...
                float horizontalMoveForce = direction.x * horizontalForce;
                float jumpMoveForce = direction.y * verticalForce;
            ...
            else // Air Control
            {
                ...
                float horizontalMoveForce = direction.x * horizontalForce * airControlFactor;
                    float mass = rigidbody.mass * rigidbody.gravityScale;
